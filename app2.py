...
# 7. Button-triggered Predictions
st.subheader("Prediction")

# The button returns True only when it is clicked
if st.button("Compute CO2 Emissions", type="primary"):
    with st.spinner("Calculating..."):
        try:
            ...
            # Optional Visual indicators based on the score
    ...
    st.info("Adjust the parameters in the sidebar and click the **Compute CO2 Emissions** button above to generate a prediction.")